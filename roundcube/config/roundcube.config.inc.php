...
$config['db_dsnw'] = '{{cfg.roundcube.database.provider}}://{{cfg.roundcube.database.username}}:{{cfg.roundcube.database.password}}@{{cfg.roundcube.database.host}}/{{cfg.roundcube.database.name}}';
...
$config['imap_host'] = '{{cfg.roundcube.imap.security}}://{{cfg.roundcube.imap.host}}:{{cfg.roundcube.imap.port}}';
...
$config['smtp_host'] = '{{cfg.roundcube.smtp.security}}://{{cfg.roundcube.smtp.host}}:{{cfg.roundcube.smtp.port}}';
...
// To specify different SMTP user credentials for different IMAP hosts provide an array
// of IMAP host (no prefix or port) and SMTP user e.g. ['imap.example.com' => '%u']
$config['smtp_user'] = '{{cfg.roundcube.smtp.auth_user}}';

// SMTP password (if required)
// Note: When set to '%p' current user's password will be used
// Note: To disable user authentication set smtp_user and smtp_pass to ''.
// To specify different SMTP user credentials for different IMAP hosts provide an array
// of IMAP host (no prefix or port) and SMTP password e.g. ['imap.example.com' => '%p']
$config['smtp_pass'] = '{{cfg.roundcube.smtp.auth_pass}}';
...
$config['log_dir'] = '{{pkg.svc_datapkg_svc_var_path}}/' . 'logs/';

// Location of temporary saved files such as attachments and cache files
// must be writeable for the user who runs PHP process (Apache user if mod_php is being used)
$config['temp_dir'] = '{{pkg.svc_datapkg_svc_var_path}}/' . 'temp/';
...
$config['product_name'] = '{{cfg.roundcube.name}}';
...
// save compose message every 60 seconds (5min)
