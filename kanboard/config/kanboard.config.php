...
// Plugins directory
{{if cfg.kanboard.storage_directory}}
define('PLUGINS_DIR', '{{cfg.kanboard.storage_directory}}'.DIRECTORY_SEPARATOR.'plugins');
...
define('PLUGIN_INSTALLER', {{cfg.kanboard.plugin_installer}});

// Folder for uploaded files (must be writeable by the web server user)
define('FILES_DIR', '{{cfg.kanboard.storage_directory}}'.DIRECTORY_SEPARATOR.'files');

// Enable/disable email configuration from the user interface
define('MAIL_CONFIGURATION', false);

// E-mail address used for the "From" header (notifications)
define('MAIL_FROM', '{{cfg.kanboard.mail.from}}');
...
{{#if cfg.kanboard.mail.smtp.enabled}}
define('MAIL_SMTP_HOSTNAME', '{{cfg.kanboard.mail.smtp.hostname}}');
define('MAIL_SMTP_PORT', {{cfg.kanboard.mail.smtp.port}});
define('MAIL_SMTP_USERNAME', '{{cfg.kanboard.mail.smtp.username}}');
define('MAIL_SMTP_PASSWORD', '{{cfg.kanboard.mail.smtp.password}}');
...
define('DB_DRIVER', '{{cfg.kanboard.db.driver}}');

// Database username
define('DB_USERNAME', '{{cfg.kanboard.db.username}}');

// Database password
define('DB_PASSWORD', '{{cfg.kanboard.db.password}}');

// Database hostname
define('DB_HOSTNAME', '{{cfg.kanboard.db.hostname}}');

// Database database name
define('DB_NAME', '{{cfg.kanboard.db.name}}');

// Database custom port (null = default port)
define('DB_PORT', {{cfg.kanboard.db.port}});
