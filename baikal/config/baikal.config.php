...
define("PROJECT_TIMEZONE", '{{cfg.baikal.timezone}}');
...
define("BAIKAL_INVITE_FROM", '{{cfg.baikal.invite_from}}');

# WebDAV authentication type; default Digest
define("BAIKAL_DAV_AUTH_TYPE", '{{cfg.baikal.auth.type}}');

# Baïkal Web admin password hash; Set via Baïkal Web Admin
define("BAIKAL_ADMIN_PASSWORDHASH", 'BAIKAL_ADMIN_PASSWORDHASH_VALUE');