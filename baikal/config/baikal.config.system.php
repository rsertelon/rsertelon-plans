...
define("BAIKAL_AUTH_REALM", '{{cfg.baikal.auth.realm}}');
...
define("PROJECT_DB_MYSQL_HOST", '{{cfg.baikal.database.host}}');

# MySQL > Database name
define("PROJECT_DB_MYSQL_DBNAME", '{{cfg.baikal.database.name}}');

# MySQL > Username
define("PROJECT_DB_MYSQL_USERNAME", '{{cfg.baikal.database.username}}');

# MySQL > Password
define("PROJECT_DB_MYSQL_PASSWORD", '{{cfg.baikal.database.password}}');

# A random 32 bytes key that will be used to encrypt data
define("BAIKAL_ENCRYPTION_KEY", 'BAIKAL_ENCRYPTION_KEY_VALUE');
